    ...
    e && Object.deepExtend(d, e), d.tmp.obj = {
        ...
        if (d.tmp.img_error = void 0, "" != d.particles.shape.image.src)
            if ("svg" == t) {
                ...
                e.open("GET.html", d.particles.shape.image.src), e.onreadystatechange = function(t) {
        ...
        else console.log("Error%20pJS%20-%20No%20image.html"), d.tmp.img_error = !0
...
Object.deepExtend = function(t, e) {
    ...
    a.open("GET.html", t), a.onreadystatechange = function(t) {
        if (4 == a.readyState)
            if (200 == a.status) {
